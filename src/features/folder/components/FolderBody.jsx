...
function FolderBody() {
  ...
  const handleChangeModalTitle = (title) => setModalTitle(title)
  const handleSelectedUrl = (url) => setDeletedUrl(url)
  ...
  const addMyFolderModal = ModalPortal(<AddMyFolderModal data={categoryState.data?.data} />)
