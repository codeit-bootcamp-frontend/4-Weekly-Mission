...
import facebook from '../../images/modal_facebook.svg';
import link from '../../images/modal_link.svg';
    ...
    <div className="modal_container">
      <section className="modal_layout" onClick={blockEvent}>
        ...
        <div className="shared_icons_container">
          <a className="shared_icon" href={`호스트 주소}/shared/{currrentFolderId`}>
            <img className="shared_icon_img" src={kakao} alt="카카오톡 아이콘"></img>
            <span className="shared_icon_text">카카오톡</span>
          </a>
          <a className="shared_icon" href={`호스트 주소}/shared/{currrentFolderId`}>
            <img className="shared_icon_img" src={facebook} alt="페이스북 아이콘"></img>
            <span className="shared_icon_text">페이스북</span>
          </a>
          <a className="shared_icon" href="" onClick={copyClipBoard}>
            <img className="shared_icon_img" src={link} alt="링크복사 아이콘"></img>
