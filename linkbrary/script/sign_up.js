...
tags.email_input.addEventListener('focus', () => {function_module.remove_error_msg(tags.email_error_msg)})
...
tags.pw_input.addEventListener('focus', () => {function_module.remove_error_msg(tags.password_error_msg)})
...
tags.repeat_pw_input.addEventListener('focus', () => {function_module.remove_error_msg(tags.repeat_password_error_msg)})
...
sign_up_btn.addEventListener('click' , (e) => {
    function_module.checkEmailPwSignUp(e, tags.email_input, tags.pw_input, tags.repeat_pw_input)})
