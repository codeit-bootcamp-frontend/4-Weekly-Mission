...
\* TODO - 36. 데이터 연결 안되는 부분 수정

\* NOTE

- 각각의 폴더 데이터에 데이터 연결이 안되는 문제 해결
- 데이터 없을 떄 데이터가 없는 메세지를 표시하는 페이지가 안나오는 문제 해결

\* TODO - 37. 검색기능 구현

\* NOTE

- shared 페이지 실시간 반영되는 검색기능 구현
- folder 페이지 검색 결과에 따라 URL 쿼리값이 변경되도록 검색기능 구현

\* TODO - 38. 모달 스타일 수정 및 공유 기능 구현
...
\* TODO - 39. 검색기능 수정 및 코드 전반적인 수정

\* NOTE

- folder 페이지 검색시 폴더 넘기면 검색결과 안나오는 문제 해결
